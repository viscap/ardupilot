...
using serialRS232::MillisecondTimer;
using serialRS232::Serial;
using serialRS232::SerialException;
using serialRS232::PortNotOpenedException;
using serialRS232::IOException;
...
void
Serial::SerialImpl::setTimeout (serialRS232::Timeout &timeout)
{
  timeout_ = timeout;
}
...
void
Serial::SerialImpl::setBytesize (serialRS232::bytesize_t bytesize)
{
  bytesize_ = bytesize;
  if (is_open_)
    reconfigurePort ();
...
void
Serial::SerialImpl::setParity (serialRS232::parity_t parity)
{
  parity_ = parity;
  if (is_open_)
    reconfigurePort ();
...
void
Serial::SerialImpl::setStopbits (serialRS232::stopbits_t stopbits)
{
  stopbits_ = stopbits;
  if (is_open_)
    reconfigurePort ();
...
void
Serial::SerialImpl::setFlowcontrol (serialRS232::flowcontrol_t flowcontrol)
{
